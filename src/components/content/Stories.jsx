...
export default function Stories() {
    ...
    const showData = dataStories.map((item, key) => (
        <Link
            ...
            className="flex transition-all flex-row justify-center p-5 border-2 border-solid bg-white dark:border-zinc-700 dark:bg-zinc-900 rounded-sm items-center dark:hover:border-lime-600 dark:hover:bg-gradient-to-r dark:hover:from-primary-600 dark:hover:to-primary-alt hover:bg-gradient-to-r hover:from-primary-600 hover:to-primary-alt hover:border-none active:scale-90 hover:text-white"
        >
            {item.name}
        </Link>
    ));
