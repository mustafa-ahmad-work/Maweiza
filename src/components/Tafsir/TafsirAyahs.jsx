...
export default function TafsirAyahs({ id }) {
    ...
    if (!surahData || !tafsirData || !albitaqatData)
        return (
            <div className="text-center pb-24 bg-gradient-to-br from-white to-green-50 dark:from-zinc-950 dark:to-zinc-950">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-green-600 mx-auto"></div>
                <p className="mt-4 text-gray-600 dark:text-zinc-300">جارٍ تحميل بيانات التفسير...</p>
            </div>
        );
    ...
    return (
        <section className="relative pb-16 px-4 bg-gradient-to-br from-white to-green-50 dark:from-zinc-950 dark:to-zinc-950 min-h-screen">
            {/* خلفية زخرفية */}
            ...
            <div className="container mx-auto relative max-w-6xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
                    {[
                        ...
                        <motion.div
                            ...
                            className="p-6 rounded-2xl shadow-lg bg-white dark:bg-zinc-950 border border-green-100 dark:border-zinc-700/80 transition-all relative overflow-hidden"
                        >
                ...
                <motion.div
                    ...
                    dir="rtl"
                    className="text-right bg-gradient-to-r from-white/70 to-green-50/70 dark:from-zinc-900/70 dark:to-zinc-950/70 p-10 rounded-3xl shadow-xl border border-green-100 dark:border-zinc-700/80 backdrop-blur-sm leading-loose md:leading-relaxed text-3xl md:text-4xl font-quran text-gray-900 dark:text-white"
                >
                ...
                <AnimatePresence>
                    {selectedAyah && (
                        <>
                            ...
                            >
                                <div
                                    className="bg-gradient-to-br from-white to-green-50 dark:from-zinc-950 dark:to-zinc-950 rounded-3xl shadow-2xl max-w-3xl w-full p-16 border border-green-200 dark:border-zinc-700/80 relative overflow-hidden"
                                ...
                                >
                                    ...
                                    <button
                                        onClick={() => setSelectedAyah(null)}
                                        className="absolute top-4 left-4 text-gray-500 hover:text-green-600 dark:hover:text-green-500 w-12 h-12 flex items-center justify-center rounded-full bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm transition-all z-10"
                                        aria-label="إغلاق"
                                    >
                                        <svg
                                    ...
                                    <div className="relative z-10">
                                        <h3 className="text-xl md:text-2xl font-quran !leading-[70px] text-right text-gray-900 dark:text-white mb-8 p-6 bg-green-100/50 dark:bg-green-900/30 rounded-2xl border border-green-200 dark:border-green-800/50">
                                            ...
                                            <span
                                                className="inline-flex items-center justify-center mx-2 text-base md:text-lg font-cairo font-bold text-emerald-700 dark:text-emerald-400
                                                    ...
                                                    bg-gradient-to-br from-white to-emerald-50 dark:from-zinc-950 dark:to-zinc-950
                                        ...
                                        <p className="text-xl text-gray-700 dark:text-zinc-300 leading-relaxed bg-white/50 dark:bg-zinc-900 p-8 rounded-2xl border border-gray-200 dark:border-zinc-800">
