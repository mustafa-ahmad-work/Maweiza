...
export default function AuthorQuotes({ params }) {
    ...
    const showData = filterData.map((item, index) => (
        <div
            key={index}
            className="group relative bg-white dark:bg-zinc-900 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl mb-6 transform hover:-translate-y-1">
            ...
            <div className="p-6 md:p-8">
                <div className="flex justify-center mb-5">
                    <div className="relative">
                        ...
                        <div className="relative bg-white dark:bg-zinc-900 rounded-full p-3">
                            <svg
                ...
                <blockquote className="text-center">
                    <p className="text-xl md:text-2xl leading-relaxed font-medium text-gray-800 dark:text-zinc-200 mb-6">
                        {item.text}
                    </p>
            ...
            <div className="bg-gray-50 dark:bg-zinc-950/50 px-6 py-4 flex justify-center items-center gap-4">
                <button
                    onClick={() => copyText(`"${item.text}" - ${item.author}`)}
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-zinc-900 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900 hover:bg-emerald-50 dark:hover:bg-zinc-800/80/30 hover:text-emerald-700 dark:hover:text-emerald-300 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50"
                ...
                <button
                    ...
                    className={`flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-zinc-900 ${savedQuotes.includes(item.id) ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-zinc-400'} border border-emerald-200 dark:border-emerald-900 hover:bg-emerald-50 dark:hover:bg-zinc-800/80/30 hover:text-emerald-700 dark:hover:text-emerald-300 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50`}
    ...
    return (
        <>
            {/* <Landing
                ...
                className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-zinc-950 dark:to-zinc-950"
            /> */}
            <ToastContainer
                theme="colored"
            ...
            />
            <section className="py-12 relative px-4 bg-gradient-to-b from-emerald-50/50 to-white dark:from-zinc-950/50 dark:to-zinc-950">
                <div className="container mx-auto max-w-4xl">
                    ...
                    {filterData.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-white dark:bg-zinc-900 rounded-xl shadow-md">
                            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-100 dark:bg-zinc-900/30 mb-4">
