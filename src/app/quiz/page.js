            ...
            return (
                <div className="space-y-8">
                    <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold text-primary-700 mb-2">اختر القسم</h2>
                        <p className="text-gray-600 dark:text-zinc-300">اختر الفئة التي تريد الاختبار فيها</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {data?.mainCategories.map((category) => (
                            <div
                                ...
                                className="group relative overflow-hidden rounded-xl bg-white dark:bg-zinc-900 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border border-gray-200 dark:border-zinc-800"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-primary to-teal-500 opacity-0 group-hover:opacity-5 transition-opacity"></div>
                                <div className="p-6">
                                    <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 rounded-lg bg-primary-100 dark:bg-zinc-900/30 flex items-center justify-center ml-4">
                                            <span className="text-primary-600 dark:text-primary-400 font-bold">{category.id}</span>
                                        </div>
                                        <h3 className="text-xl font-bold text-primary-800 dark:text-white">{category.arabicName}</h3>
                                    </div>
                                    <p className="text-gray-600 dark:text-zinc-300 text-sm">{category.description}</p>
            ...
            return (
                <div className="space-y-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-3xl font-bold text-primary-700 mb-2">اختر الموضوع</h2>
                            <p className="text-gray-600 dark:text-zinc-300">اختر الموضوع الذي ترغب في الاختبار فيه</p>
                        </div>
                        <button
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-3">
                                        <div className="w-10 h-10 rounded-lg bg-primary-100 dark:bg-zinc-900/30 flex items-center justify-center ml-3">
                                        ...
                                        <h3 className="text-lg font-bold text-primary-800 dark:text-white">{topic.name}</h3>
                                    </div>
                                    <div className="flex items-center text-sm text-gray-600 dark:text-zinc-400 mt-2">
        ...
        if (!quizSettings.difficulty) {
            return (
                <div className="space-y-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-3xl font-bold text-primary-700 mb-2">اختر مستوى الصعوبة</h2>
                            <p className="text-gray-600 dark:text-zinc-300">اختر المستوى المناسب لك</p>
                        </div>
                        <button
    ...
    return (
        <>
            ...
            <div className="container mx-auto px-4 py-10 max-w-6xl">
                <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-zinc-800">
                    {/* Progress bar */}
                                    ...
                                    <div
                                        className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                                            step.completed
                                                ...
                                                : 'bg-gray-200 dark:bg-zinc-900 text-gray-500 dark:text-zinc-400'
                                        }`}
                                    >
                                        {step.completed ? (
