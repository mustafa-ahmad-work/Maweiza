                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 rounded-lg bg-emerald-100 dark:bg-zinc-900/30 flex items-center justify-center ml-4">
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-3">
                                        <div className="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-zinc-900/30 flex items-center justify-center ml-3">
