...
export default async function AudioCategoryPage({ params }) {
        ...
        >
            ...
            <div className="p-6">
                ...
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center">
                        ...
                        <div className="mr-3">
                            ...
                            <p className="text-xs text-gray-500 dark:text-zinc-400">المحاضر</p>
                        </div>
                    </div>
                ...
                <a href={item.attachments?.[0]?.url || '#'} className="block mb-3">
                    <h5 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                        {item.title}
                    </h5>
                </a>
                ...
                <div className="grid grid-cols-2 gap-3 mb-4 text-xs">
                    ...
                    <div className="flex items-center text-gray-500 dark:text-zinc-400">
                        <FontAwesomeIcon icon={faHeadphones} className="ml-1" />
    ...
    return (
        <>
            <Landing
                title="قسم محاضرات صوتيه"
                text="يحتوي هذا القسم على مجموعة مختارة من المحاضرات الصوتية القيمة"
            />
